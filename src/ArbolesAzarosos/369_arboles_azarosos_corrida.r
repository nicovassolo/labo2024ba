...
PARAM$rpart <- data.table( 
  "cp" = c(-1, -1, -1, -1, -1),                # cp es siempre -1 en tus combinaciones
  "minsplit" = c(250, 25, 250, 1000, 100),      # valores específicos para minsplit
  "minbucket" = c(10, 10, 10, 20, 20),          # valores específicos para minbucket
  "maxdepth" = c(4, 4, 6, 12, 4)               # valores específicos para maxdepth
)

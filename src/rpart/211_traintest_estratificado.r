...
PARAM <- list()
PARAM$semilla <- 342821
PARAM$training_pct <- 70L  # entre  1L y 99L 

# NV: aca estamos haciendo una particion random 70/30. Mi semilla va a tirar a diferentes lados.
# NV: eeentender que lla particion es estratificaada en eel campo de la clase ternaria. 
# Es decir, quiero respetar las proporcioness exactas en training y testing.

PARAM$rpart <- list (
  "cp" = -1, # complejidad minima. NV: En realidad, es un valor prohibido. Hay que buscar uno razonable.
